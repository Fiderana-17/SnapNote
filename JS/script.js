        ...
        <div class="flex justify-between items-start mb-4">
            ...
            <div class="flex items-center space-x-3 ml-3">
                <input type="checkbox" ${this.selectedNotes.has(note.id) ? 'checked' : ''} 
                       onchange="app.toggleNoteSelection('${note.id}')"
                ...
                <div class="relative">
                    ...
                    <div class="dropdown-menu hidden absolute right-0 mt-2 w-48 rounded-xl z-20">
                        <button onclick="app.openNoteModal('${note.id}')" class="flex items-center w-full text-left px-4 py-3 text-sm text-gray-700 dark:text-gray-300 hover:bg-purple-50 dark:hover:bg-purple-900/20 transition-colors duration-200 rounded-t-xl">
                            <svg class="w-4 h-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path>
                            </svg>
                            Modifier
                        </button>
                        <button onclick="app.deleteNote('${note.id}')" class="flex items-center w-full text-left px-4 py-3 text-sm text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/20 transition-colors duration-200 rounded-b-xl">
                            <svg class="w-4 h-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
